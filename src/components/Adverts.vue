  ...
  <div id="popular-jobs" role="tabpanel" class="tab-pane fade in active">
    <div class="job-ad-item">
      <div class="item-info">
        ...
        <!-- ad-info -->
        <div class="button">
          <a href="#" class="btn btn-primary">Детайли</a>
        </div>
      </div>
      <!-- item-info -->
    </div>
    ...
    <div class="job-ad-item">
      <div class="item-info">
        ...
        <div class="ad-info">
          <span
            ><a href="job-details.html" class="title">Graphics Designer</a> @
            <a href="#">AOK Security</a></span
          >
          <div class="ad-meta">
            <ul>
              <li>
              ...
              <li>
                <a href="#"
                  ><i class="fa fa-clock-o" aria-hidden="true"></i>Full Time</a
                >
              </li>
              <li>
                <a href="#"
    ...
    <div class="job-ad-item">
      <div class="item-info">
        <div class="item-image-box">
          <div class="item-image">
            <a href="job-details.html"
              ><img src="images/job/3.png" alt="Image" class="img-responsive"
            /></a>
          </div>
          <!-- item-image -->
        </div>
        ...
        <div class="ad-info">
          <span
            ><a href="job-details.html" class="title">CTO</a> @
    ...
    <div class="job-ad-item">
      <div class="item-info">
        ...
        <div class="ad-info">
          <span
            ><a href="job-details.html" class="title">Human Resource Manager</a>
            @ <a href="#">Dropbox Inc</a></span
          >
          <div class="ad-meta">
            <ul>
              <li>
