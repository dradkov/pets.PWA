                    ...
                    <div class="col-sm-9">
                      <div class="dropdown category-dropdown">
                        ...
                        <ul class="dropdown-menu category-change">
                          <div v-for="(type, index) in advertType" :key="index">
                            <li>
                              <a href="#">{{ type }}</a>
                            </li>
                          </div>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="dropdown category-dropdown">
                        ...
                        ></a>
                        <ul class="dropdown-menu category-change">
                          <div v-for="(type, index) in petType" :key="index">
                            <li>
                              <a href="#">{{ type }}</a>
                            </li>
                          </div>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="dropdown category-dropdown">
                        ...
                        ></a>
                        <ul class="dropdown-menu category-change">
                          <div v-for="(type, index) in genderType" :key="index">
                            <li>
                              <a href="#">{{ type }}</a>
                            </li>
                          </div>
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="dropdown category-dropdown">
                        ...
                        ></a>
                        <ul class="dropdown-menu category-change">
                          <div v-for="(type, index) in cities" :key="index">
                            <li>
                              <a href="#">{{ type }}</a>
                            </li>
                          </div>
                  ...
                  <div class="row form-group item-description">
                    ...
                    <div class="col-sm-9">
                      <textarea
                        id="textarea"
                        class="form-control"
                        placeholder="Допълнителна информация за обявата"
                        rows="8"
                      ></textarea>
                    </div>
                  </div>
                  <div class="button">
                    <a href="#" class="btn btn-primary">Публикувай</a>
                  </div>
                </div>
                <!-- postdetails -->
              </fieldset>
...
export default class Adverts extends Vue {
  get advertType() {
    ...
    return store.getters.advertTypes;
  }

  get petType() {
    const store = useStore(key);
    return store.getters.petTypes;
  }

  get genderType() {
    const store = useStore(key);
    return store.getters.genderTypes;
  }
  get cities() {
    const store = useStore(key);
